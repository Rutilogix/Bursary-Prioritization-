<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="User Profile.aspx.cs" Inherits="Demo_PR.User_Profile" %>
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DropDownList1" runat="server">
                             <asp:ListItem Text= "Select" Value = "select" />
                              ...
                              <asp:ListItem Text= "Limpompo" Value= "Limpompo" />
                              <asp:ListItem Text= "Mpumalanga" Value = "Mpumalanga" />
                              <asp:ListItem Text= "Northen Cape" Value = "Northen Cape" />
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                         <img width="100" src="imgs/bsu%20issuing.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col">
                        <center>
                           <h4>Your Issued Bursary</h4>
                           <asp:Label class="badge badge-pill badge-info" ID="Label2" runat="server" Text="your bursary info"></asp:Label>
                        </center>
                     </div>
                  </div>
                  <div class="row">
